...
const points = [
  "من مشاوری هستم که هم مدل‌یابی SEM هم هوش مصنوعی را به زبان پژوهشگران توضیح می‌دهم.",
    ...
    <section className="bg-brand-peach py-16 sm:py-24">
      <Container className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <SectionHeading
          ...
          description="در اینجا، تخصص هوش مصنوعی را با مدل‌یابی معادلات ساختاری در حوزه روان‌شناسی همزمان ارائه می‌دهیم. این رویکرد، پاسخ به دغدغه پژوهشگرانی‌ست که هم آمار و هم AI را نیاز دارند."
        />
